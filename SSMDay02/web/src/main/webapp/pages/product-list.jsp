...
<head>
    ...
    <!--强制修改style height:100%,解决调出调试工具,界面发生改变而因height: auto引发的页面无限拉长异常-->
    <style type="text/css">
        body{
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/product/findProduct">产品管理</a></li>
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="删除"
                                        ...
                                        <i class="fa fa-trash-o" onclick="deleteProduct()"></i> 删除
                                    </button>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick='location.href="${pageContext.request.contextPath}/product/updateShowProduct?id=${product.id}"'>
                                            修改
                                        </button>
                                    </td>
                                </tr>
...
<script type="text/javascript">
    function deleteProduct() {
        var idsList = $("input[name='ids'] [type='checkbox']:checked");
        if (idsList.length == 0) {
            alert("请先选中一行！")
            return;
        }
        var ids = ""
        $.each(idsList, function () {
            ids += $(this).val() + ",";
        })
        ids = ids.substring(0, ids.length - 1);
        location.href = "/product/deleteProduct"
    }
</script>
